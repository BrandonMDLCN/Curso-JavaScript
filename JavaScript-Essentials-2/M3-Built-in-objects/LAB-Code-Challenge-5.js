/* 
Scenario
Modify the Figure class from the previous task so that you can sort points and lines in the collection and automatically 
remove elements with the same values (e.g. lines composed of the same points).
*/
class Point{
    constructor(x,y){
        this.x = x;
